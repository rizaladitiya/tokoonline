...
echo form_open(base_url('produk/selesailaundry'),array('class'=>'form-horizontal'));
?>
<div class="">
<label class="control-label">Keterangan tambahan</label>
			<div class="form-group">
			<div class="">
				<textarea name="alamat" class="form-control" placeholder="Masukkan keterangan lokasi tambahan dan ciri-ciri rumah Anda untuk mempermudah penjemputan...."></textarea>
			</div>
		
				<button type="submit" id="oksimpan" class="btn btn-success btn-flat">Jemput Laundry</button><br>
		</div>			
		<legend>Pilih Lokasi Jemput Laundry
		</legend><div id="googlemap">
