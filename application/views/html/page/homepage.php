...
if(!empty($dPromo))
{
	...
	$urlBanner=base_url().'assets/images/no_picture.jpg';
...
<h3><img src="<?=$urlBanner;?>"  class="logo" width="50px" height="50px"><?=$rPromo->judul;?></h3>
</div>
<?php
...
$sql="SELECT produk.* FROM promo_data LEFT JOIN produk ON promo_data.produk_id = produk.produk_id left join promo on promo.promo_id=promo_data.promo_id Where promo.selesai >= '$tgl_ini' and promo_data.promo_id='$promo_id' ORDER BY produk_id DESC LIMIT 6";
...
if(!empty($dTerbaru))
{
		...
		{
			$urlPhotoBaru=base_url().'assets/images/no_picture.jpg';
        ...
        <div class="thumbnail">
        	<a href="<?=$urlProdukBaru;?>" class="link-p">
            	<img src="<?=$urlPhotoBaru;?>" alt="<?=$rBaru->nama_produk;?>">
        	</a>
            <div class="caption prod-caption">
                ...
                <p>
					...
					<br><span>
				Promo hingga <?=date('d M y',strtotime($rPromo->selesai));?></span>
                </p>
                <?php
                }
                ?>
