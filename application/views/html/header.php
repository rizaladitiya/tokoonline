        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">                	
                    ...
                    <li  class="nav-dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Ojek<span class="caret"></span>
						</a>
                        <ul class="dropdown-menu">
                        	<li><a href="<?=base_url('produk/orderojek');?>">Pesan Ojek</a></li>
                            <li><a href="<?=base_url('histori/ojekall');?>">Status Ojek</a></li>
                        </ul>
                    </li>
                    <li  class="nav-dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Laundry<span class="caret"></span>
						</a>
                        <ul class="dropdown-menu">
                        	<li><a href="<?=base_url('produk/orderlaundry');?>">Jemput Laundry</a></li>
                            <li><a href="<?=base_url('histori/laundryall');?>">Status Laundry</a></li>
                        </ul>
                    </li>
<li class="nav-dropdown">
          ...
          <li><a href="<?=base_url('download');?>" class="<?=menu_html('download');?>">Download</a></li>
                </ul>				
            </div>
        </div>
    </nav>
